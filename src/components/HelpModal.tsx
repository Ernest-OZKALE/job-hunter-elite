    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full p-6">
        ...
        <div className="mt-4 text-sm text-slate-600 space-y-3">
          <p>Les fichiers sont envoyés par défaut sur votre Google Drive (quota personnel). Pour utiliser le Storage du projet, allez dans Préférences et choisissez "Storage" — le Storage du projet doit être activé dans la console Firebase.</p>
