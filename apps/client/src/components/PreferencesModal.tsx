            ...
            <div className="glass-card w-full max-w-2xl rounded-3xl p-8 max-h-[90vh] overflow-y-auto">
                ...
                <div className="mb-8">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {[
                            ...
                            { value: 'comfort' as ViewMode, label: 'Confort', icon: 'ðŸ“±', desc: 'Vue équilibrée' },
                            { value: 'grid' as ViewMode, label: 'Grille', icon: 'ðŸŽ¯', desc: 'Mosaïque' },
                        ].map((mode) => (
                            <button
                                key={mode.value}
                    ...
                    <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50">
                        <div>
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                                {permission === 'granted'
                                    ? 'âœ… Notifications activées pour les relances'
                ...
                <div className="p-4 rounded-2xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 mb-6">
                    <p className="text-sm text-blue-900 dark:text-blue-200 text-center">
                        ðŸŽ¨ <strong>Personnalisation :</strong> Choisis un thème pour changer les couleurs principales de l'app.
                    </p>
                </div>
