...
export const parseJobOffer = (text: string): ParsedJob => {
    ...
    const companyKeywords = ['Entreprise :', 'Company:', 'ðŸ¢', 'Société :'];
    const postKeywords = ['Poste :', 'Job:', 'ðŸ’¼', 'Intitulé :'];
    ...
    return {
        company: company.replace(/[^\w\sàâéèêëîïôÃ¶ùûÃ¼çÃ€Ã‚Ã‰ÃˆÃŠÃ‹ÃŽÃÃ”Ã–Ã™Ã›ÃœÃ‡&-]/g, '').slice(0, 50).trim(),
